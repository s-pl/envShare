...
import { AccountSettingsDialog } from "../common/AccountSettingsDialog";
...
export function Navbar({ user, onLogout, crumbs = [] }: NavbarProps) {
  ...
  return (
    <>
          ...
          <div className="ml-auto flex items-center gap-1 shrink-0">
            ...
            {user && (
              <>
                ...
                {/* Account Settings — GDPR rights + ISO security controls */}
                <Button
                  variant="ghost"
                  size="sm"
      ...
      {/* Account Settings Dialog — password, sessions, GDPR data rights */}
